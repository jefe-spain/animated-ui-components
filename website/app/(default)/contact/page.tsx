export const metadata = {
  title: "Contact Us - Animated UI Components | Support & Inquiries",
  description: "Get in touch with our team for support, feature requests, or partnership opportunities. We're here to help you build better React applications with Rive animations.",
  keywords: "React components support, Rive animations contact, UI components help",
  openGraph: {
    title: "Contact Us - Animated UI Components",
    description: "Get support for React + Rive components",
    type: "website",
  }
};
